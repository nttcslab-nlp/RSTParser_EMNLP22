...
class TopDownParserV2(TopDownParserBase):
    """This top-down parser predicts nucleus and relation labels by one classifier."""

    def __init__(self, classifier: TopDownClassifierBase):
        super(TopDownParserV2, self).__init__(classifier)
    ...
    def generate_training_samples(
        ...
        for doc in dataset:
            ...
            for tp in tree.treepositions():
                ...
                ys.append({"spl": split_idx - span[0] - 1, "ful": ful_idx})
